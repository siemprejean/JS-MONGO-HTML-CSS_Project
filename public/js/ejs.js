(() => {
    const App = {
        htmlElements: {
            form: document.getElementById('formulariofoto'),
            ...
            botonVolver: document.getElementById('botonvolv'),
        },
        init() {
            ...
            async mostrarImagenUsuario() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        App.htmlElements.imagenPerfil.src = imageUrl;
                    ...
                    App.htmlElements.imagenPerfil.src = defaultImageUrl;
                    App.htmlElements.imagenUsuario.alt = 'Imagen de Usuario';
                    App.htmlElements.imagenPerfil.alt = 'Imagen de Usuario';
                }
            }
        }
    };
